...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-navy-mid border-t border-border-dark py-20">
      <div className="max-w-[1140px] mx-auto px-16 grid grid-cols-2 md:grid-cols-4 gap-16">
        ...
        <div className="flex flex-col">
          <h4 className="text-[0.7rem] font-bold tracking-[0.12em] uppercase text-white mb-5">Support</h4>
          <ul className="list-none flex flex-col gap-3">
            <li><a className="text-muted-dark hover:text-white text-[0.85rem] transition-colors cursor-pointer">Help Center</a></li>
            <li><a className="text-muted-dark hover:text-white text-[0.85rem] transition-colors cursor-pointer">Contact Us</a></li>
            <li><a className="text-muted-dark hover:text-white text-[0.85rem] transition-colors cursor-pointer">Pricing</a></li>
            <li><a className="text-muted-dark hover:text-white text-[0.85rem] transition-colors cursor-pointer">Privacy Policy</a></li>
          </ul>
        </div>
      </div>
