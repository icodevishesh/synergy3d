...
export default function UPSShippingModal({ isOpen, onClose }: UPSShippingModalProps) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="flex items-start justify-between p-6 pb-4">
          <div className="flex items-center gap-3">
            {/* UPS Logo SVG */}
            <div className="w-10 h-10 bg-[#FFB500] rounded-lg flex items-center justify-center">
              <span className="text-[#351C15] font-black text-sm">UPS</span>
            </div>
            <div>
              <h2 className="text-lg font-bold text-gray-900">Generate a Shipping Label</h2>
